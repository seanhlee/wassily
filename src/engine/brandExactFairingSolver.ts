    ...
    if (index === seedIndex) {
      ...
      for (const profile of semanticProfiles) {
        color = mixColorsInLab(
          color,
          profile.lightColor(linearProgress, seedIndex),
          profile.lightBlend(linearProgress),
          exactSeed.h,
          targetGamut,
        );
      }
      ...
      for (const profile of semanticProfiles) {
        color = mixColorsInLab(
          color,
          profile.darkColor(color, progress),
          profile.darkBlend(progress),
          exactSeed.h,
          targetGamut,
        );
      }
